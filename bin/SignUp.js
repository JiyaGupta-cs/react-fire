                ...
                <form className="space-y-4 md:space-y-6" action="#" onSubmit={onSubmit}>
                    <div>
                        ...
                        <input
                                        ...
                                        required     
                                        label="Email address"    
                                        value={email}                                                                      className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  
                  ...
                  />
                    ...
                    <p className="text-sm font-light flex justify-between pr-2 text-gray-500 dark:text-gray-400">
                        ...
                        <NavLink className="font-medium text-primary-600 hover:underline dark:text-primary-500" to="/login">                      
                        Login
                        </NavLink>
